 ...
 *
 * Adapted from
 * https://gitlab.com/ico_gl/ua_tqs_gs20/-/blob/master/gs-mockForHttpClient/src/main/java/geocoding/AddressResolverService.java?ref_type=heads
 * 
 */
public class AddressResolverService {
    ...
    public static String prepareUriForRemoteEndpoint(double latitude, double longitude) throws URISyntaxException {
        ...
        try(Formatter fmt = new Formatter()){
            ...
            uriBuilder.addParameter("location", fmt.format(Locale.US, "%.5f,%.5f", latitude, longitude).toString());
